...
class BillingLogic:
    ...
    def process_consumption(self, kwh_used, tariff: TariffPlan):
        ...
        self.consumer.consumption_records.append(
            ConsumptionRecord(timestamp, kwh_used, subsidy_units, energy_charge_total, fixed_charge, total_deduction, balance_before, balance_after)
        )
